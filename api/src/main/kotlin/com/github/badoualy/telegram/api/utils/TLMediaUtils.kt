...
//        val inputFileLocation = InputFileLocation(TLInputDocumentFileLocation(document.id, document.accessHash, document.fileReference,if (document.thumbs!=null) document.thumbs.size.toString() else "0"), document.dcId)
...
//}
//
//fun TLAbsInputFileLocation.toInputFileLocation() = when (this) {
//    is TL -> InputFileLocation(TLInputFileLocation(volumeId, localId, secret), dcId)
