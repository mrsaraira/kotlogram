...
public class TLMessageFwdHeader extends TLObject {
    ...
    public TLMessageFwdHeader(boolean imported, TLAbsPeer fromId, String fromName, int date, Integer channelPost, String postAuthor, TLAbsPeer savedFromPeer, Integer savedFromMsgId, String psaType) {
