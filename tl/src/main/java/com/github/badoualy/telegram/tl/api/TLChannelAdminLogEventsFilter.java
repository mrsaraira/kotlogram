...
public class TLChannelAdminLogEventsFilter extends TLObject {
    ...
    public TLChannelAdminLogEventsFilter(boolean join, boolean leave, boolean invite, boolean ban, boolean unban, boolean kick, boolean unkick, boolean promote, boolean demote, boolean info, boolean settings, boolean pinned, boolean edit, boolean delete, boolean groupCall, boolean invites, boolean send) {
        this.join = join;
        this.leave = leave;
        this.invite = invite;
        this.ban = ban;
