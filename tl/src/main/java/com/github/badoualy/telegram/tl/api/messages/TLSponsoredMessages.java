...
public class TLSponsoredMessages extends TLObject {
    public static final int CONSTRUCTOR_ID = 0x65a4c7d5;
    ...
    private final String _constructor = "messages.sponsoredMessages#65a4c7d5";

    public TLSponsoredMessages() {
    }

    public TLSponsoredMessages(TLVector<TLSponsoredMessage> messages, TLVector<TLAbsChat> chats, TLVector<TLAbsUser> users) {
