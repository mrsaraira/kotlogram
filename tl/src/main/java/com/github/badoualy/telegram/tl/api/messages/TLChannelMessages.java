...
public class TLChannelMessages extends TLAbsMessages {
    ...
    public TLChannelMessages(boolean inexact, int pts, int count, Integer offsetIdOffset, TLVector<TLAbsMessage> messages, TLVector<TLAbsChat> chats, TLVector<TLAbsUser> users) {
