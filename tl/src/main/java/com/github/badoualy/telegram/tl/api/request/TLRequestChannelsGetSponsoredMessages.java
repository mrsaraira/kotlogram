...
public class TLRequestChannelsGetSponsoredMessages extends TLMethod<TLSponsoredMessages> {
    ...
    public TLRequestChannelsGetSponsoredMessages() {
    }

    public TLRequestChannelsGetSponsoredMessages(TLAbsInputChannel channel) {
