...
public class TLChannelAdminLogEventActionExportedInviteRevoke extends TLAbsChannelAdminLogEventAction {
    public static final int CONSTRUCTOR_ID = 0x410a134e;

    protected TLChatInviteExported invite;

    private final String _constructor = "channelAdminLogEventActionExportedInviteRevoke#410a134e";

    public TLChannelAdminLogEventActionExportedInviteRevoke() {
    }

    public TLChannelAdminLogEventActionExportedInviteRevoke(TLChatInviteExported invite) {
        this.invite = invite;
    }
