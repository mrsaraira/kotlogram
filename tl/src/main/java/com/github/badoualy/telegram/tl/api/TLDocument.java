...
public class TLDocument extends TLAbsDocument {
    ...
    public TLDocument(long id, long accessHash, TLBytes fileReference, int date, String mimeType, int size, TLVector<TLAbsPhotoSize> thumbs, TLVector<TLVideoSize> videoThumbs, int dcId, TLVector<TLAbsDocumentAttribute> attributes) {
        this.id = id;
